...
public class DateInterval extends Interval<Date> {
     ...
     *              of its ends. See {@link IntervalTree.Interval.Bounded the documentation of the Bounded enum}
     *              for more information on the different possibilities.
     */
    public DateInterval(Date start, Date end, IntervalTree.Interval.Bounded type, String ID) {
     ...
     *              as well as if it is open or closed at the bounding point. See {@link IntervalTree.Interval.Unbounded
     *              the Unbounded enum} for description of the different possibilities.
     */
    public DateInterval(Date value, IntervalTree.Interval.Unbounded type) {
        super(value, type);
    }
