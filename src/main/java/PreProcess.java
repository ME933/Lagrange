...
//    HashMap<Integer,LinkedList[]> subQue;
    ...
    public PreData getPreData() throws ParseException {
        ...
        this.generateMap();
        this.generateCon();
        this.preData = new PreData(starList,equList,arcList,mapStarArc,mapEquArc,mapStarEquArc,conArc,eachArcConNum,starIndexMap,equIndexMap,arcIndexMap,mapArcStar,mapArcStar,mapArcTime,mapArcRai,equConPair);
        return preData;
    }
